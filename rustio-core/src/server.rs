...
impl Server {
    ...
    /// Run until Ctrl-C. Active connections get ~30s to drain before
    /// we hard-stop.
    pub async fn run(self) -> Result<()> {
        ...
        // Give in-flight requests 30s to finish. Spawned tasks that
        // don't finish in time are dropped by the runtime.
...
/// Serve a static file from disk. Tiny, safe-ish — strips separators
/// and rejects `..`.
...
pub fn embedded_rustio_css() -> &'static str {
