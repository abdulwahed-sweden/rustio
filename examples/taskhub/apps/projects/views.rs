...
/// Tutorial page for the `Project` app.
///
/// Hitting `GET /projects` returns the HTML below so you can confirm the
/// app is wired up. Replace this handler with your real view — this file
/// is yours to edit freely.
pub fn register(router: Router) -> Router {
    router.get("/projects", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Project app · RustIO</p>
  <p>Your <code>Project</code> app is wired up and serving this page at <code>/projects</code>.</p>
  <p>To build a real view, edit <code>apps/projects/views.rs</code>. The CRUD admin for this model is already generated and ready to use.</p>
  <div class="actions">
    <a class="btn primary" href="/admin/projects">Open admin</a>
