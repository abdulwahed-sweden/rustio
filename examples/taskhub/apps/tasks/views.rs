...
/// Tutorial page for the `Task` app.
///
/// Hitting `GET /tasks` returns the HTML below so you can confirm the
/// app is wired up. Replace this handler with your real view — this file
/// is yours to edit freely.
pub fn register(router: Router) -> Router {
    router.get("/tasks", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Task app · RustIO</p>
  <p>Your <code>Task</code> app is wired up and serving this page at <code>/tasks</code>.</p>
  <p>To build a real view, edit <code>apps/tasks/views.rs</code>. The CRUD admin for this model is already generated and ready to use.</p>
  <div class="actions">
    <a class="btn primary" href="/admin/tasks">Open admin</a>
