...
/// Tutorial page for the `Location` app. `GET /locations` confirms the app is
/// wired up; replace this handler with your real view.
pub fn register(router: Router) -> Router {
    router.get("/locations", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Location app · bookflow</p>
  <p>Your <code>Location</code> app serves this page at <code>/locations</code>. Edit
     <code>apps/locations/views.rs</code> to build a real view; the CRUD admin is already generated.</p>
  <a class="btn" href="/admin/locations">Open admin</a>
</main>
</body>
</html>"##;
