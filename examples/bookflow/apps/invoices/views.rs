...
/// Tutorial page for the `Invoice` app. `GET /invoices` confirms the app is
/// wired up; replace this handler with your real view.
pub fn register(router: Router) -> Router {
    router.get("/invoices", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Invoice app · bookflow</p>
  <p>Your <code>Invoice</code> app serves this page at <code>/invoices</code>. Edit
     <code>apps/invoices/views.rs</code> to build a real view; the CRUD admin is already generated.</p>
  <a class="btn" href="/admin/invoices">Open admin</a>
</main>
</body>
</html>"##;
