...
/// Tutorial page for the `Booking` app. `GET /bookings` confirms the app is
/// wired up; replace this handler with your real view.
pub fn register(router: Router) -> Router {
    router.get("/bookings", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Booking app · bookflow</p>
  <p>Your <code>Booking</code> app serves this page at <code>/bookings</code>. Edit
     <code>apps/bookings/views.rs</code> to build a real view; the CRUD admin is already generated.</p>
  <a class="btn" href="/admin/bookings">Open admin</a>
</main>
</body>
</html>"##;
