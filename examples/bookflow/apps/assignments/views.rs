...
/// Tutorial page for the `Assignment` app. `GET /assignments` confirms the app is
/// wired up; replace this handler with your real view.
pub fn register(router: Router) -> Router {
    router.get("/assignments", |_req, _params| async {
...
<head>
<meta charset="utf-8">
<title>Assignment — bookflow</title>
<style>
...
<main>
  <h1>It works.</h1>
  <p class="tag">Assignment app · bookflow</p>
  <p>Your <code>Assignment</code> app serves this page at <code>/assignments</code>. Edit
     <code>apps/assignments/views.rs</code> to build a real view; the CRUD admin is already generated.</p>
  <a class="btn" href="/admin/assignments">Open admin</a>
</main>
</body>
</html>"##;
