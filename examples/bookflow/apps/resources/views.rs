...
/// Tutorial page for the `Resource` app. `GET /resources` confirms the app is
/// wired up; replace this handler with your real view.
pub fn register(router: Router) -> Router {
    router.get("/resources", |_req, _params| async {
...
<main>
  <h1>It works.</h1>
  <p class="tag">Resource app · bookflow</p>
  <p>Your <code>Resource</code> app serves this page at <code>/resources</code>. Edit
     <code>apps/resources/views.rs</code> to build a real view; the CRUD admin is already generated.</p>
  <a class="btn" href="/admin/resources">Open admin</a>
</main>
</body>
</html>"##;
